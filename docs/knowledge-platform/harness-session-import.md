...
are refused. Limits are 256 MiB per file, 2 GiB total and 10,000 files. The
...
PuddingClaw Home (a 158 MB largest original PDF, 67 MB largest Markdown body,
about 300 MiB of sessions, 50 MB catalog.sqlite3) that exceeded them, so they
were raised to the unified migration budgets shared with Knowledge. The source snapshot envelope
