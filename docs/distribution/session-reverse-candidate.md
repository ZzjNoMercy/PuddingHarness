...
aggregate, 50,000 entries) and session import (256 MiB per file, 2 GiB aggregate,
...
real-data rehearsal measured a real PuddingClaw Home (a 158 MB largest
original PDF, 67 MB largest Markdown body, about 300 MiB of sessions, 50 MB
catalog.sqlite3) exceeding them; the source
